...
Func _MoveMouse($Coordinates)
	MouseUp("")
	BlockInput(1)
	MouseMove(($Coordinates[0]-158),  ($Coordinates[1]-144+93), 0); instant($mouse_button, ($Coordinates[0] + $Coordinates[2]) / 2, ($Coordinates[1] + $Coordinates[3]) / 2, $number_of_clicks, 0)
	MouseClick("left", ($Coordinates[0]-158),  ($Coordinates[1]-144+93), 1)
	BlockInput(0)
EndFunc   ;==>_ClickMouse
